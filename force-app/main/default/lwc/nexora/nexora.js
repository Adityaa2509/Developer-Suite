...
export default class Nexora extends LightningElement {
    ...
    @track chatMessages = [
        { id: 1, text: "Hello! I am Nexora's Schema Copilot. Drag & drop a schema file or type a prompt to build custom Salesforce components.", sender: 'ai', cssClass: 'chat-msg chat-msg--ai' }
    ];
    @track draftFields = [];
